...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function() {var stringInvertida = "";for (var i = this.length-1; i >= 0; i--)
...
function agregarMetodo() {
  ...
  Persona.prototype.datos = function() {return "Juan" + ", " + "22" +" años"}
  /// is it working?! //this.nombre - this.edad
}
